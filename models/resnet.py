...
class ResNet(Module):
    ...
    def initialize(self, mode: str, scale_factor: float = 1., mean: float = 0., softmax_init: bool = False,
        ...
        initialize_model([self.cnn1], mode, scale_factor, mean, softmax_init, a, b)
        initialize_model(self.layer1, mode, scale_factor, mean, softmax_init, a, b)
        initialize_model(self.layer2, mode, scale_factor, mean, softmax_init, a, b)
        initialize_model(self.layer3, mode, scale_factor, mean, softmax_init, a, b)
        initialize_model(self.layer4, mode, scale_factor, mean, softmax_init, a, b)
        initialize_model([self.fnn1], mode, scale_factor, mean, softmax_init, a, b)
    def forward(self, x: torch.Tensor) -> torch.Tensor:
